...
const ShiftLightForStorybook = (props: Parameters<typeof ShiftLight>[0]) => {
  return <ShiftLight {...props} />;
};
...
export const Comparison: Story = {
  render: () => (
    <div className="space-y-6">
      <div className="text-white text-xl font-bold mb-6">
        Shift Point Alert Styles Comparison
      </div>
